...
const Feature = () => {
  ...
  return (
    <div className="mx-auto px-4 py-10" id="features">
      <div className="bg-blue-600 text-white p-8 md:p-10 text-center mb-8 2xl:rounded">
      ...
      <div className="container mx-auto">
        <div className="grid gap-6 md:grid-cols-3">
          {visibleFeatures.map((feature) => (
            ...
            >
              <div className="flex-shrink-0 rounded-full bg-blue-500 text-white w-12 h-12 flex items-center justify-center text-xl font-bold">
                {feature.number}
              </div>
              <div>
                <h2 className="text-xl font-semibold mb-1 text-gray-700">{feature.title}</h2>

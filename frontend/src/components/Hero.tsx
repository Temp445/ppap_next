      ...
      <div className="relative min-h-fit container mx-auto">
        ...
        <div className="relative z-10 max-w- mx-auto px-4 sm:px-6 py-4">
          ...
          <div className="md:hidden flex gap-1 mx-auto justify-center w-fit  px-6 md:mt-6   -mt-16 ">
            ...
            <span className="text-lg font-bold text-black tracking-wide mt-1">ACE CMS</span>
          </div>
            ...
            <div className="w-full text-center lg:text-left order-2 lg:order-1">
              <div className="md:max-w-2xl mx-auto lg:mx-0 space-y-8">
                <div className="space-y-4">
                  <h1 className='md:hidden text-xl text-gray-800 font-bold text-center'>Production Part Approval Process (PPAP) Services for High-Quality, Compliant Manufacturing</h1>
                  <h1 className=" hidden md:block text-4xl md:text-5xl lg:text-4xl xl:text-4xl 2xl:text-5xl font-black text-gray-800 leading-tight">
                ...
                <p className=" text-sm md:text-xl text-[#273F4F] leading-relaxed font-medium max-w-xl mx-auto lg:mx-0">
                Automate Your PPAP Workflow with Industry-Leading Software — Deliver Quality Faster, Every Time
                </p>

  <div>
  <ul className="list-none pl-0 space-y-2 text-gray-800 font-semibold grid gap-4 grid-cols-2 md:grid-cols-3 lg:grid-cols-3">
    ...
    <li><span className="text-indigo-500 mr-2">&#9679;</span>Process Flow</li>
                ...
                <div className="md:pt-4">
                  <Link href="#contact" className="group inline-flex items-center gap-3 px-4 py-2 md:px-8 md:py-4 lg:px-6 lg:py-3 bg-orange-600  text-white text-sm md:text-lg font-bold rounded-lg  shadow-xl hover:shadow-2xl">

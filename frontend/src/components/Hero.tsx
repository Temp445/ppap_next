...
const Hero = () => {
  return (
    <div className="relative min-h-fit overflow-hidden bg-[#0962EA]" id="top">
    ...
    />
            ...
            <div className="w-full text-center lg:text-left order-2 lg:order-1">
              <div className="md:max-w-2xl mx-auto lg:mx-0 space-y-8">
                ...
                <p className=" text-sm md:text-xl text-white leading-relaxed font-medium max-w-xl mx-auto lg:mx-0">
  ...
  <ul className="list-none pl-0 space-y-2 text-white font-semibold grid gap-4 grid-cols-2 md:grid-cols-3 lg:grid-cols-3">
    ...
    <li><span className="text-indigo-500 mr-2">&#9679;</span>Process Flow</li>
                ...
                <div className="md:pt-4">
                  <Link href="#contact" className="group inline-flex items-center gap-3 px-4 py-2 md:px-8 md:py-4 lg:px-6 lg:py-3 border hover:border-orange-600 hover:bg-orange-600  text-white text-sm md:text-lg font-bold rounded-lg  shadow-xl hover:shadow-2xl">
